...
function FeaturedCourses() {
    return (
        <div className="container mx-auto mb-3 px-4 py-4 max-w-screen-xl">
            <h2 className="font-lato text-center text-3xl font-bold">A-Level Courses</h2>
            <div className="flex flex-wrap justify-center mt-4">
                {alevel.map((course) => (
                    <Link href="#" key={course.id} className="bg-white shadow border m-4 mx-2 p-4 flex flex-col items-center w-60 hover:shadow-lg transition-shadow duration-200 max-sm:w-full"> {/* Card styling */}
            ...
            <div className="flex justify-center mt-6">
                <Link href="#" className="text-center bg-ginger text-white rounded px-4 py-2 hover:bg-ginger/90 font-bold">
                    All Courses
                </Link>
            </div>
        </div>
